...
/* harmony import */ var _modules_slider_mini_sliders__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/slider/mini-sliders */ "./src/js/modules/slider/mini-sliders.js");
/* harmony import */ var _modules_videoPlay__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/videoPlay */ "./src/js/modules/videoPlay.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var sliders = new _modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.page',
    btns: '.next',
    logoBtn: '[data-logo-btn]'
  });
  sliders.render();
  var modulePageSliders = new _modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    btns: '.moduleapp .next',
    logoBtn: '[data-logo-btn]',
  ...
  var showUpSlider = new _modules_slider_mini_sliders__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  showUpSlider.init();
  var modulesSlider = new _modules_slider_mini_sliders__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  modulesSlider.init();
  var feedSlider = new _modules_slider_mini_sliders__WEBPACK_IMPORTED_MODULE_1__["default"]({
    container: '.feed__slider',
    prev: '.feed__slider .slick-prev',
    next: '.feed__slider .slick-next',
    activeClass: 'feed__item-active'
  });
  feedSlider.init(); // play video

  new _modules_videoPlay__WEBPACK_IMPORTED_MODULE_2__["default"]('.showup .play', '.overlay').init();
  new _modules_videoPlay__WEBPACK_IMPORTED_MODULE_2__["default"]('.module__wrapper .play', '.overlay').init(); // diferense

  var diferenseOld = new _modules_diference__WEBPACK_IMPORTED_MODULE_3__["default"]('[data-item-officerold]', '.officerold .plus', '[data-remove-old]');
  diferenseOld.init();
  var diferensNew = new _modules_diference__WEBPACK_IMPORTED_MODULE_3__["default"]('[data-item-officernew]', '.officernew .plus', '[data-remove-new]');
  diferensNew.init(); // form

  new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]('.form').init(); // accordion

  new _modules_accordion__WEBPACK_IMPORTED_MODULE_5__["default"]('.module__wrapper .plus').init(); // download
      ...
      try {
        this.btn.forEach(function (item) {
          item.addEventListener('click', function () {
            var element = item.closest('.module__info-show').nextElementSibling;
...
/*#__PURE__*/
function () {
  function Difference(items, btns, btnsRemove) {
    ...
    value: function bindTriggers() {
      ...
      try {
        this.btns.addEventListener('click', function () {
          ...
          if (_this.counter == 3) {
            _this.removeBtn.style.display = 'none';
          }
        });
      } catch (e) {}
    }
...
function () {
  ...
  _createClass(Download, [{
    key: "download",
    value: function download(path, pictureName) {
    ...
    value: function init() {
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function (e) {
          ...
          switch (num) {
            case '1':
              _this.download(_this.way.mod1, 'picture-1');
            ...
            case '2':
              _this.download(_this.way.mod2, 'picture-2');
            ...
            case '3':
              _this.download(_this.way.mod3, 'picture-3');
...
function () {
  ...
  _createClass(Forms, [{
    ...
    value: function checkEmailInput() {
      var emailInput = document.querySelectorAll('[name="email"]');
      emailInput.forEach(function (input) {
        input.addEventListener('input', function (e) {
          var inputText = e.target.value;
          var filteredText = inputText.replace(/[^a-z 0-9 @ \.]/ig, '');
...
function (_Slider) {
  ...
  function MainSlider(btns, logoBtn, prevModule, nextModule) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns, logoBtn, prevModule, nextModule));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.logoBtn.forEach(function (item) {
...
/***/ "./src/js/modules/slider/mini-sliders.js":
/*!***********************************************!*\
  !*** ./src/js/modules/slider/mini-sliders.js ***!
  \***********************************************/
/*! exports provided: default */
    ...
    value: function nextSlide() {
      for (var i = 1; i < this.slides.length; i++) {
        if (this.slides[1].tagName == 'BUTTON' && this.slides[2].tagName == 'BUTTON') {
          ...
          var thirdSlide = this.slides[2]; // Удаляем первые три слайда из текущей позиции

          this.container.removeChild(firstSlide);
          this.container.removeChild(secondSlide);
          this.container.removeChild(thirdSlide); // Добавляем первые три слайда в конец контейнера
    ...
    value: function init() {
      ...
      try {
        ...
        if (this.autoPlay) {
          ...
          this.slides[0].parentNode.addEventListener('mouseout', function () {
            _this4.autoPlayGo();
          });
        }
      } catch (e) {}
...
/*#__PURE__*/
function () {
  function VideoPlay(btnsSelector, overlay) {
  ...
  _createClass(VideoPlay, [{
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          if (!btn.querySelector('.closed')) {
            ...
            _this.overlay.classList.add('animated', 'fadeInDown');

            if (document.querySelector('iframe#frame')) {
              _this.overlay.style.display = 'flex'; // проверяется, является ли путь к видео, 
              ...
              if (_this.path !== btn.getAttribute('data-url')) {
                ...
                _this.path = btn.getAttribute('data-url'); // а видео перезапускается с новым путём.
    ...
    key: "closeTrigger",
    value: function closeTrigger() {
      var _this2 = this;

      this.close.addEventListener('click', function () {
        _this2.overlay.classList.remove('animated', 'fadeInDown');

        _this2.overlay.style.display = 'none';

        if (_this2.player && _this2.player.getPlayerState() !== null) {
